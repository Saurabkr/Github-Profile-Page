      ...
      <div className="px-2 py-4">
        ...
        <div className="relative pl-6">
          <div className="relative pb-6 flex flex-row gap-2 items-center">
            <div className="h-[50px] w-[2px] bg-gray-200"></div>
            <div className="absolute translate-x-[-45%] translate-y-[20%] top-[2px] bg-gray-100 p-2 z-10 rounded-full">
              <GoLock className="w-[14px] h-[14px]  text-gray-700 rounded-full " />
            </div>
        ...
        <div className="pt-4">
          <button className="w-full text-center text-sm text-[#539bf5] hover:underline py-2 font-medium border border-gray-200 rounded-md">
